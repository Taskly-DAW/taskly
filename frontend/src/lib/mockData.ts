...
// --- Responsáveis Comuns ---
const RESPONSIBLE_MO: Responsible = {
  name: 'Maria Oliveira',
  avatarUrl: '/img/avatars/mo.jpg',
  initials: 'MO',
};
const RESPONSIBLE_JS: Responsible = {
  name: 'João Silva',
  avatarUrl: '/img/avatars/js.jpg',
  initials: 'JS',
};
const RESPONSIBLE_AS: Responsible = {
  name: 'Ana Souza',
  avatarUrl: '/img/avatars/as.jpg',
  initials: 'AS',
};
const RESPONSIBLE_CL: Responsible = {
  name: 'Carlos Lima',
  avatarUrl: '/img/avatars/cl.jpg',
  initials: 'CL',
};
...
export const MOCK_TASKS: Task[] = [
  ...
  {
    id: 'T004',
    title: 'Revisão de performance do banco',
    status: 'Concluídas',
    priority: 'Alta',
    dueDate: '2025-05-15',
  ...
  {
    id: 'T005',
    title: 'Preparar documentação API v1',
    status: 'Concluídas',
    priority: 'Média',
    dueDate: '2025-06-05',
    responsible: RESPONSIBLE_MO,
  ...
  {
    id: 'T006',
    title: 'Implementar autenticação Zod',
    status: 'Concluídas',
    priority: 'Alta',
    dueDate: '2025-06-12',
    responsible: RESPONSIBLE_JS,
  ...
  {
    id: 'T007',
    title: 'Teste de usabilidade do modal',
    status: 'Concluídas',
    priority: 'Média',
    dueDate: '2025-05-25',
    responsible: RESPONSIBLE_AS,
  ...
  {
    id: 'T010',
    title: 'Criar wireframes p/ relatórios',
    status: 'Em Andamento',
    priority: 'Média',
    dueDate: '2025-07-20',
    responsible: RESPONSIBLE_MO,
  ...
  {
    id: 'T012',
    title: 'Revisão de segurança do código',
    status: 'Atrasadas',
    priority: 'Alta',
    dueDate: '2025-04-01',
    responsible: RESPONSIBLE_JS,
  ...
  {
    id: 'T013',
    title: 'Atualizar políticas de privacidade',
    status: 'Atrasadas',
    priority: 'Média',
    dueDate: '2025-05-01',
    responsible: RESPONSIBLE_MO,
  ...
  {
    id: 'T014',
    title: 'Planejamento da Sprint 3',
    status: 'A Fazer',
    priority: 'Alta',
    dueDate: '2025-08-01',
    responsible: RESPONSIBLE_MO,
