...
from app.usecases.dtos import RegisterDTO, LoginDTO, TokenResponse, UserInfoDTO
...
async def list_users(x_tenant_id: str = Header(...), current_user: dict = Depends(get_current_user)):
